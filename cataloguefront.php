				...
				<div class="container">
                    ...
                    <ul class="header-links pull-right">
                        ...
                        <li><a href="fidelite.html"><i class="fa fa-user-o"></i> Fidelité</a></li>
                          <li><a href="back/index.html"><i class="fa fa-user-o"></i> Gérer ma boutique</a></li>
                    </ul>
				</div>
			</div>
			<!-- /TOP HEADER -->
	 ...
	 ?>
										...
										<div class="product">
											...
											<div class="product-body">
												...
												<button  class="add-to-cart-btn"><i ></i> consulter produit</button>

												
												<input type="text" name ="id" value="<?PHP echo $row['id_article']?>"/>
